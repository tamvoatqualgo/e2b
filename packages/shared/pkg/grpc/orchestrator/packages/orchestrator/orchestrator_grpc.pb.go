...
const (
	...
	SandboxService_Cmd_FullMethodName              = "/SandboxService/Cmd"
...
type SandboxServiceClient interface {
	...
	Cmd(ctx context.Context, in *SandboxCmdRequest, opts ...grpc.CallOption) (*SandboxCmdResponse, error)
...
func (c *sandboxServiceClient) Cmd(ctx context.Context, in *SandboxCmdRequest, opts ...grpc.CallOption) (*SandboxCmdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SandboxCmdResponse)
	err := c.cc.Invoke(ctx, SandboxService_Cmd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SandboxServiceServer interface {
	...
	Cmd(context.Context, *SandboxCmdRequest) (*SandboxCmdResponse, error)
...
func (UnimplementedSandboxServiceServer) Cmd(context.Context, *SandboxCmdRequest) (*SandboxCmdResponse, error) {
...
func _SandboxService_Cmd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SandboxCmdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxServiceServer).Cmd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_Cmd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).Cmd(ctx, req.(*SandboxCmdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Cmd",
			Handler:    _SandboxService_Cmd_Handler,
		},
		{
	...
	Metadata: "packages/orchestrator/orchestrator.proto",
}
